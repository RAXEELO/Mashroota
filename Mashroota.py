...
os.system("clear")
print  """
\x1b[1;93m___________________________________________________
\x1b[1;95m  BOSS RAXEELO
\x1b[1;96m MASHROOTA LAILA
\x1b[1;97m ____________________________________________________
"""

####Logo####

logo1 = """
\x1b[1;93m______________________________________________
\x1b[1;95m BOSS RAXEELO
\x1b[1;96m MASHROOTA LAILA
\x1b[1;97m______________________________________________
"""
logo2 = """
\x1b[1;93m______________________________________________
\x1b[1;95m BOSS RAXEELO
\x1b[1;96m MASHROOTA LAILA
\x1b[1;97m _________________________________________________
"""
CorrectUsername = "MASHROOTA"
CorrectPassword = "LAILA"
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
        ...
        if (password == CorrectPassword):
            print "Logged in successfully as " + username #MASHROOTA
	    time.sleep(2)
            loop = 'false'
        else:
            print "\033[1;94mWrong Password"
            os.system('xdg-open https://www.facebook.com/profile.php?id=100004570304826/UCnpo3IZafwXQDcWsh67JK-Q')
    else:
...
def action():
    ...
    if peak =='':
        ...
        print '\x1b[1;92m[TELENOR]\x1b[1;91m[JAZZ]\x1b[1;93m[ZONG]\x1b[1;95m[UFONE]'
        try:
            c = raw_input("\033[1;97mRAXEELO-᙭ᗪ➤")
            k="03"
            idlist = ('.txt')
    ...
    p.map(main, id)
    print 50* '\033[1;91m-'
    print 'Mashroota clone Has Been Completed ...'
